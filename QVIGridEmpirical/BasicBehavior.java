...
public class BasicBehavior {
	...
	public static void main(String[] args) {
		...
		//example.experimenterAndPlotterGoal01();
		example.experimenterAndPlotterGoalJoint();
	...
	public void QLearningExample(String outputPath){
		...
		LearningAgent agent = new QLearning(domain, rf, tf, 0.99, hashingFactory, 0., 1.0);
	...
	public void experimenterAndPlotterGoalJoint(){

		//custom reward function for more interesting results
		final RewardFunction rf10 = new GoalBasedRF(this.goalCondition, 1, 0);
		final RewardFunction rf0_1 = new GoalBasedRF(this.goalCondition, 0, -1);

		/**
		 * Create factories for Q-learning agent
		 */
		LearningAgentFactory LearningFactory101 = new LearningAgentFactory() {

			@Override
			public String getAgentName() {
				return "Q Goal Reward 1 init";
			}
			...
			public LearningAgent generateAgent() {
				...
				return new QLearning(domain, rf10, tf, 0.99, hashingFactory, 1.0, 1.0);
			}
		};

		LearningAgentFactory LearningFactory10 = new LearningAgentFactory() {

			@Override
			public String getAgentName() {
				return "Q Goal Reward";
			}

			@Override
			public LearningAgent generateAgent() {
				//Domain domain, RewardFunction rf, TerminalFunction tf, double gamma, StateHashFactory hashingFactory, double qInit, double learningRate
				return new QLearning(domain, rf10, tf, 0.99, hashingFactory, 0.0, 1.0);
			}
		};

		LearningAgentFactory LearningFactory0_1 = new LearningAgentFactory() {

			@Override
			public String getAgentName() {
				return "Q Action Penalty";
			}

			@Override
			public LearningAgent generateAgent() {
				//Domain domain, RewardFunction rf, TerminalFunction tf, double gamma, StateHashFactory hashingFactory, double qInit, double learningRate
				return new QLearning(domain, rf0_1, tf, 0.99, hashingFactory, 0.0, 1.0);
			}
		};
		...
		LearningAlgorithmExperimenter exp = new LearningAlgorithmExperimenter((SADomain)this.domain,
			rf10, sg, 10, 100, LearningFactory10, LearningFactory0_1, LearningFactory101);
	...
	public void experimenterAndPlotterGoal01(){

		//custom reward function for more interesting results
		final RewardFunction rf = new GoalBasedRF(this.goalCondition, 1, 0);
		...
		LearningAgentFactory LearningFactory = new LearningAgentFactory() {
			...
			public LearningAgent generateAgent() {
				//Domain domain, RewardFunction rf, TerminalFunction tf, double gamma, StateHashFactory hashingFactory, double qInit, double learningRate
				return new QLearning(domain, rf, tf, 0.99, hashingFactory, 1.0, 1.0);
			}
		};
	...
	public void experimenterAndPlotterQSARSA(){
